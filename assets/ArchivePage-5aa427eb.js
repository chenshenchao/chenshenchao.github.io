...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(e=>e.path==a.path)),s=async e=>{const r=e.params.path,i=`/archives/${r}`;r!=a.path&&(a.path=r,a.content=await _(i),n.title=v(a.content))};return b(async()=>{console.log("onActivied"),await s(l)}),u(async(e,r)=>{console.log("onBeforeRouteUpdate"),await s(e)}),(e,r)=>{var i,p;return P(),w("div",B,[t("div",{class:"md-archive-sheet",innerHTML:a.content},null,8,k),t("div",x,[t("div",G,[I,t("span",null,c((i=m.value)==null?void 0:i.createAt),1)]),t("div",J,[R,t("span",null,c((p=m.value)==null?void 0:p.modifyAt),1)])])])}}});const bt=S(T,[["__scopeId","data-v-51031ea2"]]);export{bt as default};
