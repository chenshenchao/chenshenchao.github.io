import{d as h,u,r as _,c as g,o as v,a as f,b as y,e as A,w,f as C,g as e,t as d,p as P,h as b}from"./index-017a464a.js";import{l as H}from"./archive-9b39b078.js";import{_ as x}from"./plugin-vueexport-helper-c27b6911.js";const p=r=>(P("data-v-2826af6c"),r=r(),b(),r),B={class:"archive-info"},G={class:"archive-info-item"},I=p(()=>e("span",null,"创建日期：",-1)),J={class:"archive-info-item"},S=p(()=>e("span",null,"修改日期：",-1)),R=["innerHTML"],V=h({__name:"ArchivePage",setup(r){const l=u(),a=_({content:"",path:""}),o=g(()=>[{path:"reading/one-hundred-years-of-solitude.md",createAt:"2023-11-09",modifyAt:"2023-11-16",mtime:1700145907e3,title:"读《百年孤独》\r",summary:`# 读《百年孤独》\r
\r
人类的意义是什么？——不断创造意义。\r
\r
意义的载体——逻辑。\r
