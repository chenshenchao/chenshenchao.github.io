...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].map(async t=>({...t,path:`/archives/${t.path}`,link:`/archive/${t.path}`,summary:t.summary?await x.parse(t.summary+"..."):void 0}));e.archives=await Promise.all(r),console.log("load",e.archives)}),(r,t)=>{const o=p("sidebar"),u=p("banner"),_=p("router-link"),l=p("double-column-layout"),d=p("noise-filter");return c(),A(d,null,{default:m(()=>[y(l,{class:"index-page"},{minor:m(()=>[y(o,{onSearch:t[0]||(t[0]=n=>e.searchText=n)})]),background:m(()=>[L]),default:m(()=>[y(u),(c(!0),h(H,null,B(E(i),n=>(c(),h("div",M,[n.summary?(c(),h("div",{key:0,class:"archive-summary",innerHTML:n.summary},null,8,j)):(c(),A(_,{key:1,to:n.link},{default:m(()=>[k(f(n.title),1)]),_:2},1032,["to"])),s("div",D,[n.summary?(c(),h("div",F,[y(_,{to:n.link},{default:m(()=>[k("查看全文")]),_:2},1032,["to"])])):S("",!0),s("div",O,[R,s("span",null,f(n.createAt),1)]),s("div",W,[$,s("span",null,f(n.modifyAt),1)])])]))),256))]),_:1})]),_:1})}}});const Bt=G(q,[["__scopeId","data-v-16967a23"]]);export{Bt as default};
