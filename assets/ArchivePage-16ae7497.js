...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(e=>e.path==a.path)),i=async e=>{const t=e.params.path,o=`/archives/${t}`;t!=a.path&&(a.path=t,a.content=await _(o))};return A(async()=>{console.log("onActivied"),await i(l)}),f(async(e,t)=>{console.log("onBeforeRouteUpdate"),await i(e)}),(e,t)=>{const o=p("pc-banner"),u=p("pc-center-part-layout");return b(),w(u,{class:"pc-archive-page"},{background:c(()=>t[0]||(t[0]=[r("div",{class:"background"},null,-1)])),default:c(()=>{var m,s;return[C(o),r("div",k,[r("div",H,[t[1]||(t[1]=r("span",null,"创建日期：",-1)),r("span",null,d((m=n.value)==null?void 0:m.createAt),1)]),r("div",x,[t[2]||(t[2]=r("span",null,"修改日期：",-1)),r("span",null,d((s=n.value)==null?void 0:s.modifyAt),1)])]),r("div",{class:"archive-sheet",innerHTML:a.content},null,8,B)]}),_:1})}}});const lt=P(G,[["__scopeId","data-v-9ff4849c"]]);export{lt as default};
