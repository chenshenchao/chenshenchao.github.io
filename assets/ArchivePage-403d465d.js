...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(e=>e.path==a.path)),m=async e=>{const t=e.params.path,i=`/archives/${t}`;t!=a.path&&(a.path=t,a.content=await u(i),o.title=h(a.content))};return y(async()=>{console.log("onActivied"),await m(c)}),l(async(e,t)=>{console.log("onBeforeRouteUpdate"),await m(e)}),(e,t)=>{var i,s;return _(),b("div",P,[r("div",{class:"md-archive-sheet",innerHTML:a.content},null,8,C),r("div",H,[r("div",k,[t[0]||(t[0]=r("span",null,"创建日期：",-1)),r("span",null,p((i=n.value)==null?void 0:i.createAt),1)]),r("div",B,[t[1]||(t[1]=r("span",null,"修改日期：",-1)),r("span",null,p((s=n.value)==null?void 0:s.modifyAt),1)])])])}}});const ft=w(x,[["__scopeId","data-v-51031ea2"]]);export{ft as default};
