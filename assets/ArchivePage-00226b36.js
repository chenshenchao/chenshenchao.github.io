...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(r=>r.path==e.path)),s=async r=>{const a=r.params.path,n=`/archives/${a}`;a!=e.path&&(e.path=a,e.content=await v(n))};return w(async()=>{console.log("onActivied"),await s(u)}),y(async(r,a)=>{console.log("onBeforeRouteUpdate"),await s(r)}),(r,a)=>{const n=d("pc-banner"),_=d("pc-center-part-layout");return P(),C(_,{class:"pc-archive-page"},{background:l(()=>[B]),default:l(()=>{var p,c;return[I(n),t("div",G,[t("div",J,[S,t("span",null,h((p=m.value)==null?void 0:p.createAt),1)]),t("div",V,[N,t("span",null,h((c=m.value)==null?void 0:c.modifyAt),1)])]),t("div",{class:"archive-sheet",innerHTML:e.content},null,8,R)]}),_:1})}}});const vt=x(j,[["__scopeId","data-v-9ff4849c"]]);export{vt as default};
