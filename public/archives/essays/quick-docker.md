...
- [moby](https://github.com/moby/moby) docker 的基础库。
...
- [portainer](https://github.com/portainer/portainer) Docker 和 Kubernetes 的 web 管理面板服务器。
- [dive](https://github.com/wagoodman/dive) 命令行工具，查看 docker 镜像层。
- [diving](https://github.com/vicanso/diving) 基于 dive 的 web 研究 docker 镜像层。
- [docui](https://github.com/skanehira/docui) Go 开发的命令行管理工具。
- [oxker](https://github.com/mrjackwills/oxker) rust 开发的命令行管理工具。
- [kafka-docker](https://github.com/wurstmeister/kafka-docker) kafka 的 dockerfile 构建项目。
