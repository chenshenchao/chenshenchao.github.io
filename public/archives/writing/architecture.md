...
- HCM/HRM（Human Capital Management / Human Resource Management）人力 资本/资源 管理：员工在职周期管理。
- LMS（Learning Management System）学习管理系统：课程管理、线上学习、考试测评、培训计划、学习路径、学分管理、培训效果追踪等。
- OA（Office Automation）办公自动化：集成请假、报销、审批、文件管理等日常办公自动化。
- BPM（Business Process Management）业务流程管理：优化流程，打通 ERP、OA、CRM 。
- CRM（Customer Relationship Management）客户关系管理：注重对企业外部客户关系管理。
- DMS（Dealer Management System）经销商管理系统：经销商准入、订单、库存、价格管控、促销、返利结算、终端门店管理等。
- ERP（Enterprise Resource Planning）企业资源计划：注重管理企业内部。
- BI（Business Intelligence）商业智能：数据建模分析。
- SCM（Supply Chain Management）供应链管理：供应商寻源、采购计划、订单协同、物流跟踪、库存协同、经销商管理等。
- SRM（Supplier Relationship Management）供应商关系管理：供应商准入、资质审核、询比价、招投标、采购订单协同、供货质量管控、供应商绩效评估、对账结算等。
- WMS（Warehouse Management System）仓储管理系统：入库、上架、拣货、复核、出库、盘点、库位管理、批次 / 序列号管理等。
- TMS（Transportation Management System）运输管理系统：运输计划、运力调度、运单跟踪、在途监控、运费结算、承运商管理、异常处理等。
- OMS（Order Management System）订单管理系统：线上线下多平台订单归集、智能审单、订单拆分 / 合并、库存占用、发货调度、售后订单处理、订单对账等。
- MES（Manufacturing Execution System）制造执行系统：生产排程、生产报工、设备管理、质量管控、物料追溯、车间数据采集等。
- APS（Advanced Planning and Scheduling）高级计划与排程：优化排产。
- QMS（Quality Management System）质量管理系统：来料检验（IQC）、过程检验（IPQC）、成品检验（FQC）、出货检验（OQC）、不合格品管理、质量追溯、客诉处理、ISO 体系管理、质量数据分析等。
- FMS（Financial Management System）财务管理系统：总账、应收应付、固定资产、费用报销、财务报表、预算、税务管理等。
- EAS（Enterprise Asset Management）企业资产管理：资产企业设计，覆盖资产采购、台账、运维保养、维修、盘点折旧、报废处置等。
- PLM（Product Lifecycle Management）产品生命周期管理：创意、研发、设计、工艺、生产、销售到退市的全生命周期管理。
- PDM（Product Data Management）产品数据管理：产品研发阶段的图纸、文档、BOM、物料、版本变更等。
- PMS（Project Management System）项目管理系统：项目立项、进度管理、任务分配、资源调度、成本管控、风险管理、文档管理、项目复盘等。
