...
很多外行常会出现的情况，就是把定语忽略，抹除前后词，只记住一个修剪后的结论。
比如下面这两句话：

1. 在语法上，C 比 C++ 容易学。
2. 在开发上有更多库的支持，C++ 比 C 容易用。
...
这样就导致了相反的结论，这样的事情屡见不鲜。
常常外行会刻板地记住其中一个结论，在之后与人争论的时候就会立场坚定地反驳他人。
很多骂战就是 A 记住了 结论1，B 记住了 结论2，然后开始互喷。
很多所谓的技术大牛在面对自己不擅长的问题，碍于面子也经常会出现这种情况。
解决这种争论也很简单，具体问题，具体分析。
这些结论其实就是因为具体的定语被删除了，只留下了空泛而不准确的结论。
