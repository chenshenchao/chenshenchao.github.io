...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].map(async t=>({...t,path:`/archives/${t.path}`,link:`/md/archive/${t.path}`,summary:t.summary?await y.parse(t.summary+"..."):void 0}));a.archives=await Promise.all(n),console.log("load",a.archives)}),(n,t)=>{const i=P("router-link");return o(),s("div",N,[(o(!0),s(w,null,C(I(h),r=>(o(),s("div",S,[r.summary?(o(),s("div",{key:0,class:"archive-summary",innerHTML:r.summary},null,8,J)):(o(),H(i,{key:1,to:r.link},{default:d(()=>[l(c(r.title),1)]),_:2},1032,["to"])),e("div",U,[r.summary?(o(),s("div",L,[T(i,{to:r.link},{default:d(()=>[l("查看全文")]),_:2},1032,["to"])])):B("",!0),e("div",M,[j,e("span",null,c(r.createAt),1)]),e("div",D,[F,e("span",null,c(r.modifyAt),1)])])]))),256))])}}});const Ct=G(O,[["__scopeId","data-v-73b4b6bd"]]);export{Ct as default};
