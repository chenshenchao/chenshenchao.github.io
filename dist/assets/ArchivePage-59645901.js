...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(e=>e.path==a.path)),m=async e=>{const o=e.params.path,n=`/archives/${o}`;o!=a.path&&(a.path=o,a.content=await g(n))};return C(async()=>{console.log("onActivied"),await m(_)}),f(async(e,o)=>{console.log("onBeforeRouteUpdate"),await m(e)}),(e,o)=>{const n=d("pc-banner"),h=d("pc-center-part-layout");return P(),k(h,{class:"pc-archive-page"},{background:l(()=>[G]),default:l(()=>{var p,c;return[w(n),t("div",I,[t("div",J,[S,t("span",null,u((p=s.value)==null?void 0:p.createAt),1)]),t("div",V,[L,t("span",null,u((c=s.value)==null?void 0:c.modifyAt),1)])]),t("div",{class:"archive-sheet",innerHTML:a.content},null,8,M)]}),_:1})}}});const ft=B(N,[["__scopeId","data-v-8a1e3bb7"]]);export{ft as default};
