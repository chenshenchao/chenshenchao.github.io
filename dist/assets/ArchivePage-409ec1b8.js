...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(e=>e.path==r.path)),s=async e=>{const a=e.params.path,n=`/archives/${a}`;a!=r.path&&(r.path=a,r.content=await g(n))};return w(async()=>{console.log("onActivied"),await s(h)}),v(async(e,a)=>{console.log("onBeforeRouteUpdate"),await s(e)}),(e,a)=>{const n=d("pc-banner"),_=d("pc-center-part-layout");return C(),P(_,{class:"pc-archive-page"},{background:l(()=>[G]),default:l(()=>{var c,p;return[H(n),t("div",I,[t("div",J,[S,t("span",null,u((c=m.value)==null?void 0:c.createAt),1)]),t("div",V,[N,t("span",null,u((p=m.value)==null?void 0:p.modifyAt),1)])]),t("div",{class:"archive-sheet",innerHTML:r.content},null,8,R)]}),_:1})}}});const gt=B(j,[["__scopeId","data-v-9ff4849c"]]);export{gt as default};
