...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].find(r=>r.path==a.path)),s=async r=>{const e=r.params.path,i=`/archives/${e}`;e!=a.path&&(a.path=e,a.content=await _(i),n.title=A(a.content))};return b(async()=>{console.log("onActivied"),await s(l)}),u(async(r,e)=>{console.log("onBeforeRouteUpdate"),await s(r)}),(r,e)=>{var i,p;return w(),P("div",S,[t("div",{class:"md-archive-sheet",innerHTML:a.content},null,8,k),t("div",B,[t("div",x,[G,t("span",null,c((i=m.value)==null?void 0:i.createAt),1)]),t("div",J,[R,t("span",null,c((p=m.value)==null?void 0:p.modifyAt),1)])])])}}});const bt=H(T,[["__scopeId","data-v-51031ea2"]]);export{bt as default};
