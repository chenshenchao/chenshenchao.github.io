...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].map(async t=>({...t,path:`/archives/${t.path}`,link:`/md/archive/${t.path}`,summary:t.summary?await y.parse(t.summary+"..."):void 0}));a.archives=await Promise.all(n),console.log("load",a.archives)}),(n,t)=>{const i=P("router-link");return o(),m("div",N,[(o(!0),m(C,null,I(b(h),r=>(o(),m("div",S,[r.summary?(o(),m("div",{key:0,class:"archive-summary",innerHTML:r.summary},null,8,J)):(o(),H(i,{key:1,to:r.link},{default:c(()=>[l(p(r.title),1)]),_:2},1032,["to"])),e("div",U,[r.summary?(o(),m("div",L,[T(i,{to:r.link},{default:c(()=>[l("查看全文")]),_:2},1032,["to"])])):B("",!0),e("div",M,[j,e("span",null,p(r.createAt),1)]),e("div",D,[F,e("span",null,p(r.modifyAt),1)])])]))),256))])}}});const It=G(O,[["__scopeId","data-v-dd765801"]]);export{It as default};
