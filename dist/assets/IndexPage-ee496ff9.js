...
\r
要写博客的话 GitHub Pages 是个不错的选择。但是 GitHub Pages 是静态的，并不能像常�`}].map(async t=>({...t,path:`/archives/${t.path}`,link:`/pc/archive/${t.path}`,summary:t.summary?await k.parse(t.summary+"..."):void 0}));a.archives=await Promise.all(c),console.log("load",a.archives)}),(c,t)=>{const u=s("pc-sidebar"),v=s("pc-banner"),h=s("router-link"),A=s("pc-double-column-layout"),b=s("noise-filter");return o(),y(b,null,{default:n(()=>[d(A,{class:"pc-index-page"},{minor:n(()=>[d(u,{onSearch:t[0]||(t[0]=e=>a.searchText=e)})]),background:n(()=>[L,M]),default:n(()=>[d(v),(o(!0),l(E,null,S(V(g),e=>(o(),l("div",j,[e.summary?(o(),l("div",{key:0,class:"archive-summary",innerHTML:e.summary},null,8,D)):(o(),y(h,{key:1,to:e.link},{default:n(()=>[f(_(e.title),1)]),_:2},1032,["to"])),r("div",F,[e.summary?(o(),l("div",O,[d(h,{to:e.link},{default:n(()=>[f("查看全文")]),_:2},1032,["to"])])):G("",!0),r("div",W,[$,r("span",null,_(e.createAt),1)]),r("div",q,[Q,r("span",null,_(e.modifyAt),1)])])]))),256)),R]),_:1})]),_:1})}}});const St=U(z,[["__scopeId","data-v-ccb713ec"]]);export{St as default};
